...
const MyHealthOverview = () => {
    ...
    return (
        <div className="min-h-screen bg-slate-200/50 p-2 md:p-6 lg:p-8 flex items-center justify-center font-display text-slate-900">
            {/* Main Application Container matching the screenshot */}
            <div className="w-full max-w-[1400px] h-full lg:h-[90vh] bg-slate-50 rounded-3xl shadow-xl flex flex-col overflow-hidden">
                ...
                <div className="flex flex-1 overflow-hidden">
                    {/* Left Sidebar */}
                    <aside className="hidden md:flex w-64 border-r border-slate-200 flex-col pt-8 pb-6 px-4 shrink-0 overflow-y-auto bg-white">
                        <nav className="flex flex-col gap-2">
                            <button className="flex items-center gap-3 px-4 py-3 bg-blue-50 text-blue-600 rounded-xl font-bold text-sm transition-colors">
                                <span className="material-symbols-outlined text-[18px]">grid_view</span>
                                Overview
                            </button>
                            <button className="flex items-center gap-3 px-4 py-3 text-slate-500 hover:bg-slate-50 hover:text-slate-900 rounded-xl font-bold text-sm transition-colors">
                        ...
                        <div className="mt-auto bg-red-50 rounded-2xl p-5 border border-red-100">
                            ...
                            <a href="tel:+15550001234" className="block text-center w-full bg-red-600 hover:bg-red-700 text-white font-bold text-xs py-2.5 rounded-xl transition-colors shadow-lg shadow-red-500/20 active:scale-95">
                                Call Now
                            </a>
                        </div>
                    </aside>
                    ...
                    {/* Main Middle Area */}
                    <main className="flex-1 p-6 lg:p-10 overflow-y-auto w-full bg-slate-50/50">
                        <div className="max-w-4xl mx-auto">
                            <h1 className="text-3xl font-black text-slate-900 tracking-tight">My Health Overview</h1>
                            <p className="text-slate-500 text-sm font-medium mt-1 mb-8">Real-time medical analysis and wellness management powered by AI.</p>

                            {/* Vital Stat Cards */}
                            <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-6 mb-8">
                                {/* Heart Rate */}
                                <div className="bg-white p-6 rounded-2xl border border-slate-100 shadow-[0_2px_10px_rgba(0,0,0,0.02)] flex flex-col hover:border-blue-100 transition-colors">
                            ...
                            <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
                                ...
                                <div className="bg-white p-6 rounded-2xl border border-slate-100 shadow-[0_2px_10px_rgba(0,0,0,0.02)] flex flex-col min-h-[320px]">
                                    <div className="flex justify-between items-start mb-6">
                                        <div>
                                            <h3 className="font-bold text-slate-900 text-base mb-1">Weight Management</h3>
                                            <div className="flex items-baseline gap-2">
                                                <span className="text-3xl font-black tracking-tight">70.5 <span className="text-sm font-bold text-slate-400">kg</span></span>
                                                <span className="text-xs font-black text-rose-500">-0.5kg this week</span>
                                            </div>
                                        </div>
                                        <select className="text-xs font-bold text-slate-600 bg-slate-50 border border-slate-200 rounded-lg focus:ring-blue-500 py-2 px-3 outline-none cursor-pointer">
                                            <option>Last 7 Days</option>
                                            <option>Last 30 Days</option>
                                        </select>
                                    </div>

                                    <div className="mt-auto h-40 w-full pt-4 flex items-end">
                                        {/* Stylized SVG path representation */}
                                ...
                                <div className="bg-white p-6 rounded-2xl border border-slate-100 shadow-[0_2px_10px_rgba(0,0,0,0.02)] flex flex-col min-h-[320px]">
                                    <div className="flex justify-between items-start mb-6">
                                        <div>
                                            ...
                                            <div className="flex items-baseline gap-2">
                                                <span className="text-3xl font-black tracking-tight">8,432</span>
                                    ...
                                    <div className="mt-auto h-40 w-full flex items-end justify-between gap-3 px-2 pt-4">
                                        ...
                                        <div className="w-full bg-blue-100 rounded-t-lg h-[65%] hover:bg-blue-200 transition-colors group relative cursor-pointer"></div>
                                        <div className="w-full bg-blue-100 rounded-t-lg h-[55%] hover:bg-blue-200 transition-colors group relative cursor-pointer"></div>
                                        <div className="w-full bg-blue-100 rounded-t-lg h-[90%] hover:bg-blue-200 transition-colors group relative cursor-pointer"></div>
                                        <div className="w-full bg-blue-100 rounded-t-lg h-[60%] hover:bg-blue-200 transition-colors group relative cursor-pointer"></div>
                                        <div className="w-full bg-blue-100 rounded-t-lg h-[35%] hover:bg-blue-200 transition-colors group relative cursor-pointer"></div>
                                        <div className="w-full bg-blue-100 rounded-t-lg h-[50%] hover:bg-blue-200 transition-colors group relative cursor-pointer"></div>
                                    </div>
                    ...
                    <aside className="hidden xl:flex w-80 p-8 border-l border-slate-200 bg-slate-50/50 flex-col gap-8 overflow-y-auto shrink-0 z-10">

                        {/* Health Score Component */}
                        <div className="bg-[#1a56db] rounded-[16px] p-6 text-white shadow-lg shadow-blue-600/20 relative overflow-hidden flex flex-col items-center text-center">
                            ...
                            <div className="relative size-32 mb-6">
                                <svg className="w-full h-full transform -rotate-90 drop-shadow-md" viewBox="0 0 100 100">
                                    ...
                                    <circle cx="50" cy="50" r="42" stroke="white" strokeWidth="8" fill="none" strokeDasharray="264" strokeDashoffset="39.6" strokeLinecap="round" />
                                </svg>
                        ...
                        <div className="bg-white rounded-[16px] p-6 border border-slate-100 shadow-[0_2px_15px_rgba(0,0,0,0.02)] flex flex-col">
                        ...
                        <div className="bg-white rounded-[16px] p-6 border border-slate-100 shadow-[0_2px_15px_rgba(0,0,0,0.02)]">
                            <h3 className="text-[10px] font-extrabold text-slate-400 uppercase tracking-widest mb-4">NEXT APPOINTMENT</h3>
                            <div className="flex items-center gap-4">
                                <div className="size-10 rounded-[12px] bg-blue-50 border border-blue-100 text-blue-600 flex items-center justify-center">
                                    <span className="material-symbols-outlined text-[18px]">calendar_today</span>
                                </div>
                                <div>
                                    <h4 className="text-[13px] font-black text-slate-900 mb-1 leading-tight">Annual Physical</h4>
                                    <p className="text-[11px] font-bold text-slate-500">Oct 24, 10:00 AM</p>
                                </div>
                            </div>
                        </div>
                    </aside>
